...
def test_bit_cube():
    ...
    assert parsed_str == strip(
        """
        col0123row0{}{1}{2}{1,2}1{4}{1,4}{2,4}{1,2,4}2{8}{1,8}{2,8}{1,2,8}
        3{4,8}{1,4,8}{2,4,8}{1,2,4,8}
        """
    )
    ...
    assert parsed_str == strip(
        """0{}1{1}2{2}3{1,2}4{4}5{1,4}6{2,4}7{1,2,4}8{8}9{1,8}10{2,8}
